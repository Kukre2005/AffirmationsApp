...
@Composable
fun AffirmationsCard(affirmations: Affirmations, modifier: Modifier = Modifier) {
...
fun AffirmationsList(affirmationsList: List<Affirmations>, modifier: Modifier = Modifier){
    LazyColumn(modifier = modifier){
        items(affirmationsList){ affirmations ->
            AffirmationsCard(
...
private fun AffirmationsCardPreview(){
    AffirmationsCard(Affirmations(R.string.affirmation1, R.drawable.image1))
}
